...
class CharSpecial(Fighter, Enemy):
    ...
    def zoomer(self):
        ...
        self.opponent_stats["Attack"] -= 1
        print(f"Zoomer\'s defense is increased. {self.opponent_stats['Profile']}\'s attacks are now weaker!")
    ...
    def chad(self):
        ...
        if random.choice(roll) == 3:
            ...
            print(f"Your knockout punch failed...{self.opponent_stats['Profile']} is crippled this turn.")

    def pepe(self):
        self.char_stats["Defense"] = 3
        self.opponent_stats["Attack"] -= 1
        self.opponent_stats["Defense"] -= 1
        print("{} attack and defense lowered. REEEEE!".format(self.opponent_stats['Profile']))
...
class Effects:
    ...
    def reset_stats():
        ...
        Enemy.opponent_stats.update(opp_copy)
